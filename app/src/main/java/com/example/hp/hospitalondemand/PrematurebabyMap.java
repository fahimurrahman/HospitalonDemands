...
public class PrematurebabyMap extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prematurebaby_map);

        Firebase.setAndroidContext(this);
        hospital = new Firebase("https://bd-hospital.firebaseio.com/prematurebaby");
        initmap();
    }
    private void initmap() {
        MapFragment mapfragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFragment_prematurebaby);
    ...
    public void onLocationChanged(Location location) {
        if (location == null){
            Toast.makeText(PrematurebabyMap.this, "Can't get the location", Toast.LENGTH_SHORT).show();
        }else {
