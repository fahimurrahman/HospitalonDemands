...
public class GastricMap extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gastric_map);
        Firebase.setAndroidContext(this);
        hospital = new Firebase("https://bd-hospital.firebaseio.com/gastric");
        initmap();
    }
    private void initmap() {
        MapFragment mapfragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFragment_gastric);
    ...
    public void onLocationChanged(Location location) {
        if (location == null){
            Toast.makeText(GastricMap.this, "Can't get the location", Toast.LENGTH_SHORT).show();
        }else {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot datasnap:data){
                    ...
                    mgooglemap.addMarker(new MarkerOptions().position(new LatLng(viewholder.getLatitude(),
                            viewholder.getLongitude())).title(viewholder.getHospitalName())
                            .snippet(viewholder.getDescription()));
                }
