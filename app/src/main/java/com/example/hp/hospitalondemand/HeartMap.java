...
public class HeartMap extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hospital = new Firebase("https://bd-hospital.firebaseio.com/heart");
        initmap();
    }

    private void initmap() {
        MapFragment mapfragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFragment_heart);
    ...
    public void onLocationChanged(Location location) {
        if (location == null){
            Toast.makeText(HeartMap.this, "Can't get the location", Toast.LENGTH_SHORT).show();
        }else {
