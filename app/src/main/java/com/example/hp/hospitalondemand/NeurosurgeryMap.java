...
public class NeurosurgeryMap extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neurosurgery_map);

        Firebase.setAndroidContext(this);
        hospital = new Firebase("https://bd-hospital.firebaseio.com/neurosurgery");
        initmap();
    }

    private void initmap() {
        MapFragment mapfragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFragment_neurosurgery);
    ...
    public void onLocationChanged(Location location) {
        if (location == null){
            Toast.makeText(NeurosurgeryMap.this, "Can't get the location", Toast.LENGTH_SHORT).show();
        }else {
