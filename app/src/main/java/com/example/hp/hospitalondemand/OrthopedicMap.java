...
public class OrthopedicMap extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orthopedic_map);

        Firebase.setAndroidContext(this);
        hospital = new Firebase("https://bd-hospital.firebaseio.com/orthopedic");
        initmap();
    }

    private void initmap() {
        MapFragment mapfragment = (MapFragment) getFragmentManager().findFragmentById(R.id.mapFragment_orthopedic);
    ...
    public void onLocationChanged(Location location) {
        if (location == null){
            Toast.makeText(OrthopedicMap.this, "Can't get the location", Toast.LENGTH_SHORT).show();
        }else {
            LatLng ll = new LatLng(location.getLatitude(),location.getLongitude());
//            MarkerOptions options = new MarkerOptions().position(ll).title("You are here!");
